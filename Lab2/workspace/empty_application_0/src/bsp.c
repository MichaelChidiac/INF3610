...
void  BSP_InitIntCtrl (void)
{
    ...
    init_status = XIntc_Connect(&int_ctl, XPAR_XPS_INTC_0_FIT_TIMER_0_INTERRUPT_INTR, fitTimerHandler,(void *)0);
    init_status = XIntc_Connect(&int_ctl, XPAR_XPS_INTC_0_FIT_TIMER_1_INTERRUPT_INTR, fitTimer2Handler,(void *)0);
    XIntc_Enable(&int_ctl, XPAR_XPS_INTC_0_FIT_TIMER_0_INTERRUPT_INTR);
    XIntc_Enable(&int_ctl, XPAR_XPS_INTC_0_FIT_TIMER_1_INTERRUPT_INTR);
